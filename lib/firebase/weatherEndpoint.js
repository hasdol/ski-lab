...
const CF_REVERSE_URL = `https://${REGION}-${PROJECT_ID}.cloudfunctions.net/reverseGeocode`;
export const REVERSE_GEOCODE_ENDPOINT =
  process.env.NEXT_PUBLIC_REVERSE_GEOCODE_URL || CF_REVERSE_URL;
