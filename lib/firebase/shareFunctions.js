  ...
  const owners = await Promise.all(
    snap.docs.map(async (d) => {
      ...
      return {
        ...
        accessLevel: data.accessLevel || 'read', // Return access level
      };
    })
  );
